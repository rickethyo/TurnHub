...
try {
    ...
    & $Compiler @flags -Istubs -I../../include -I../../../shared/include scenarios.cpp test_globals.cpp profile_fixture.cpp ../../src/app_context.cpp ../../src/gameplay_intents.cpp ../../src/table_intents.cpp ../../src/moderation_intent.cpp ../../src/sigil_input.cpp ../../src/web_adapters.cpp ../../src/front_panel.cpp ../../src/audio_controller.cpp ../../src/led_renderer.cpp ../../src/controller_profiles.cpp ../../src/web_api.cpp ../../src/profile_statistics.cpp ../../src/stats_page.cpp ../../src/profile_login_page.cpp ../../src/game_engine.cpp ../../src/lobby.cpp ../../src/intent_dispatcher.cpp ../../src/client_state.cpp ../../src/game_checkpoint.cpp ../../src/game_recovery.cpp ../../src/game_recovery_store.cpp ../../src/nvs_blob_store.cpp ../../src/serial_log.cpp -o build/scenarios.exe

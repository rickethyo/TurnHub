...
<div class="grid">
 ...
 <section class="card half"><div class="card-head"><div><h2 class="eyebrow">Personalization</h2><p class="small">How you show up at the table. Saved with your profile on Atlas's microSD card.</p></div></div>
  <div id="personalSignedOut" class="notice info"><p>Sign in to choose your Sigil light colour.</p><a class="btn primary" href="/login">Sign in / create account</a></div>
  <div id="jewelBox" hidden><label for="jewelColor">Sigil light colour</label>

...
<a href="/">← Back to table</a><h1>Your TurnHub account</h1>
...
<form id="loginForm"><label for="savedProfile">Saved account</label><select id="savedProfile" required aria-describedby="loginHint"><option value="">Choose a account</option></select>
...
<p id="loginHint" class="hint">Use your 4–8 digit PIN. A account without a saved PIN can still use physical sign-in at the table, then set a PIN in My Account.</p>
<button type="submit">Sign in</button></form></section>
<section><h2>Create a account</h2><form id="registerForm">
...
<p class="hint">Signing in does not add another player. Use “Join table” in the portal. If your account is already playing, this phone controls that same player.</p>
</main><script>

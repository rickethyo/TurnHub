...
void SigilDisplay::drawCentered(const char *text, int16_t y, uint8_t maxSize) {
...
void SigilDisplay::drawTwoLines(const char *text, int16_t y, int16_t width) {

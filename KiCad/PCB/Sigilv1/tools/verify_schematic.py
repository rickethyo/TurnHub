...
rows = [
 ...
 ('Buzzer signal',33,'J12','BUZZER','BUZZER_PIN'),
 ('EPD DC',16,'A8','EPD_DC','EPD_DC'),
 ('EPD CS',17,'A9','EPD_CS','EPD_CS'),
 ('EPD clock',18,'A11','EPD_SCLK','SPI.begin(18, 19, 23, EPD_CS)'),
 ('EPD BUSY',21,'A14','EPD_BUSY','EPD_BUSY'),
 ('EPD reset',22,'A17','EPD_RST','EPD_RST'),
 ('EPD data',23,'A18','EPD_MOSI','SPI.begin(18, 19, 23, EPD_CS)'),
]
mapping = {}

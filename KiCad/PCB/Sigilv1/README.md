...
**D-pad (OLED only).** `Sigil_OLED` carries J4, five momentary switches to GND using the ESP32's internal pull-ups: Up J11/GPIO25, Down J9/GPIO27, Left A12/GPIO19, Right A14/GPIO21 (the e-ink BUSY pin, unused by the OLED) and Select J13/GPIO32. They drive the OLED menu list. *Planned*: not yet wired.
